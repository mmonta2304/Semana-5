...
public class PerfilFragment extends Fragment {
    ...
    public void inicializarListaMascotasGrid() {
        ...
        mascotas.add(new Mascota(R.drawable.cerdo, 6));
        mascotas.add(new Mascota(R.drawable.cerdo, 9));
        mascotas.add(new Mascota(R.drawable.cerdo, 1));
        mascotas.add(new Mascota(R.drawable.cerdo, 2));
        mascotas.add(new Mascota(R.drawable.cerdo, 4));
        mascotas.add(new Mascota(R.drawable.cerdo, 8));
        mascotas.add(new Mascota(R.drawable.cerdo, 3));
        mascotas.add(new Mascota(R.drawable.cerdo, 5));
        mascotas.add(new Mascota(R.drawable.cerdo, 7));
