...
public class ActivityContacto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviarEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                properties.put("mail.smtp.host", "admin.ferncuy.com.uy");
                ...
                try {
                    ...
                    transport.connect("admin.ferncuy.com.uy", Login.USER, Login.PASSWORD);
    ...
    public class Login {
        public static final String EMAIL = "petagram@ferncuy.com";
        public static final String USER = "petagram@ferncuy.com";
        public static final String PASSWORD = "VSpAVTW2pI";
    }
}